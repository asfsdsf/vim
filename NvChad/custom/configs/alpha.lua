...
local headers = {cool, iamzz, bear}
for i, asciiLine in ipairs(collections) do
  local ascii = lineToStartGradient(asciiLine)
  headers[#headers+1] = ascii
end
...
local buttons = {
  ...
  val = {
    ...
    dashboard.button("e", "  New file", "<cmd>:Lazy load scratch.vim<CR><cmd>:Scratch<CR>"),
